    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        ...
        <div class="tab-content">
          ...
          <?php 
          $currentDateTime = date('Y-m-d H:i:s'); // Get the current date and time in the database format (YYYY-MM-DD HH:mm:ss)
          ...
          $sql = "SELECT tblvehicles.VehiclesTitle, tblbrands.BrandName, tblvehicles.PricePerDay, tblvehicles.FuelType, tblvehicles.ModelYear, tblvehicles.id, tblvehicles.SeatingCapacity, tblvehicles.VehiclesOverview, tblvehicles.Vimage1 
                  ...
                  LEFT JOIN tblbooking ON tblbooking.VehicleID = tblvehicles.id
                  WHERE (tblbooking.VehicleID IS NULL OR tblbooking.todate < :currentDateTime)
                  LIMIT 9";

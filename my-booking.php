    ...
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
      <div class="vehicle_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->vid);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
          <div class="vehicle_title">
                ...
                { ?>
                <div class="vehicle_status"> <p class="text-success">Confirmed</p>
                          <div class="clearfix"></div>
              </div>

              <?php } else if($result->Status==2) { ?>
          <div class="vehicle_status"> <p href="#" class="text-danger">Cancelled</p>
            <div class="clearfix"></div>
          </div>
                ...
                <?php } else { ?>
                  <div class="vehicle_status"> <p class="text-danger">Not Confirm yet</p>
                  <!-- <div class="mt-4"> <a href="#" class="btn outline btn-xs active-btn">Pay with esewa</a></div> -->
                  <?php 
                  
                  $vid = $result->vid;

                  $vehicleSql = "SELECT * FROM tblBooking WHERE VehicleId = $vid";

                  $vehicleQuery = $dbh->prepare($vehicleSql);

                  $vehicleQuery->execute();
                  
                  $vehicleRes=$vehicleQuery->fetchAll(PDO::FETCH_OBJ);
                  ...
                  <form action="https://uat.esewa.com.np/epay/main" method="POST">
                      ...
                      <input value="<?php echo $vid?>" name="pid" type="text">
                      <input value="http://localhost/carrental/after_esewa_success.php?q=su" type="hidden" name="su">
                      <input value="http://localhost/carrental/after_esewa_failure.php?q=fu" type="hidden" name="fu">
                      <input value="Pay with esewa" name="esewa" type="submit" class="btn outline btn-xs active-btn">
                  </form>
            <div class="clearfix"></div>
        </div>
                <?php } ?>

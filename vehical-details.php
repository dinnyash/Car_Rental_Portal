      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <input type="hidden" class="form-control" name="amount" value="<?php echo htmlentities($result->PricePerDay);?>">
            </div>
              <?php if($_SESSION['login'])
                {?>
                <div class="form-group">
                  <input type="submit" class="btn"  name="submit" value="Save my details">
                </div>
                <div class="form-group">
                  <!-- <a class="btn btn-success" name="esewa" href="pay-rental.php?id=<?php //echo $_GET['vhid']?>">Pay with <img src="https://esewa.com.np/common/images/esewa_logo.png"/></a> -->
                </div>
                <?php } else { ?>
...
{ ?>      
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="pay-rental.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" /> </a>
            </div>

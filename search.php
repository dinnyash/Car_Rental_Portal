...
// Step 1: Collect User Search Input
$searchdata = $_POST['searchdata']; // Assuming you are getting the search input from a form field named 'searchdata'

// Step 2: Implement SQL Query for Filtering
...
$query = $dbh->prepare($sql);
$query->bindValue(':search', "%$searchdata%", PDO::PARAM_STR); // Using '%LIKE%' for partial matches
$query->execute();
$results = $query->fetchAll(PDO::FETCH_OBJ);
?>
